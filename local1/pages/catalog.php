    ...
    <?php
            ...
            if($result = $conn->query($sql))
            {
                foreach ($result as $row) {
                    ...
                    echo "<p class='product-price'>Сеанс ".$row['Seans'].''."</p>";
                    echo '<input type="number" min="1" max="25"  name="mesto" required> выбери место';
                    ...
                    if(isset($_SESSION['isLoggined']))
                    {
                        ...
                        echo '<a href="filminfo.php">Посмотреть инфо</a>';
                    }
